...
const Testimonials = () => {
  ...
  return (
    <section
      id="testimonials"
      className="sections-set relative w-screen text-secondary"
    >
      ...
      <div className="mt-8 flex-1 overflow-hidden relative  p-12 flex justify-center items-center rounded-lg shadow-lg mx-auto max-w-7xl bg-tertiary ">
        <h3 className="z-[5] text-center text-lg">
          ...
          millions of your potential clients, all at the same time, whether they
          are from a different country or otherwise, and your business runs even
          when you are asleep. That is{" "}
          <span className="text-primary">what growing online means</span> for
          you. Simply put, <span className="text-primary">more business!</span>
        </h3>
